// -----------------------------------------------------------------------
// <copyright file="TranspilerExtensions.cs" company="LethalAPI Event Team">
...
namespace NWAPI.CustomItems.API.Extensions
{
    ...
    public static class TranspilerExtensions
    {
        ...
        public static CodeInstruction Log(this CodeInstruction instruction, int index = 0, int injectedIndex = -1, bool enable = true, bool debug = false, Dictionary<ushort, ushort>? injectedIndexes = null)
        {
            ...
            PluginAPI.Core.Log.Debug(GetOpcodeDebugLabel(instruction, index, injectedIndex, debug ? OutputIncludes.Debug : OutputIncludes.Basic));
            return instruction;
        }
